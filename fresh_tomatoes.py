      ...
      <div class="navbar navbar-fixed-top navbar-dark bg-primary">
        <div class="container">
          <div class="navbar-header">
            ...
            <img src="http://www.mlvti.ac.in/images/logo.jpg" width="30" color="#000" class = "d-inline-block align-top" alt="Site logo">YVC CINE BOX</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <img src="{poster_image_url}" width="220" height="400">
     ...
     <div style="position: relative; bottom: 0; width: 100%; padding: 10px; color: #000; text-shadow: 2px 2px 0 #000;">
 
   <h2>{movie_title}</h2></div>
  <p>{movie_overview}</p>
